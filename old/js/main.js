...
fetch('https://www.yiketianqi.com/free/day?appid=62796679&appsecret=65y3pYZ1&unescape=1')
    .then(response => response.json())
    .then(data => {
...
$("#telegram").mouseover(function () {
    $("#link-text").html("丢一架纸飞机");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
$("#twitter").mouseover(function () {
    $("#link-text").html("望鸟儿飞向远方");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
