const ap = new APlayer({
    ...
    audio: [{
            name: "Journey",
            artist: "ARForest",
            url: "./music/journey.mp3",
            cover:"./music/journey.jpg",
            lrcUrl: "./music/journey.lrc",
            theme: "#171513"
        }
    ]
});
...
setInterval(function () {
    $("#lrc").html("<span class='lrc-show'><i class='iconfont icon-music'></i> " + "纯音乐，请欣赏" + " <i class='iconfont icon-music'></i></span>");
}, 500);
