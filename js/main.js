...
const add_id = "rplkotqlpppbgqrq"; // app_id
const app_secret = "aG13QIZTV0VyN3hvR3dKRTB0SIpidz09"; // app_secret
const key = "871b034131714ebda6bd1d9d0b61a69d" // key
function getWeather() {
...
$("#qq").mouseover(function () {
    $("#link-text").html("轻动指尖消融坚冰");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
$("#email").mouseover(function () {
    $("#link-text").html("一纸书信寄托念想");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
$("#bilibili").mouseover(function () {
    $("#link-text").html("B站个人空间");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
$("#telegram").mouseover(function () {
    $("#link-text").html("望纸飞机飞向远方");
}).mouseout(function () {
    $("#link-text").html("通过这里联系我");
});
...
$('#switchmore').on('click', function () {
    ...
    if (shoemore && $(document).width() >= 990) {
        ...
        $("#change").html("Beyond The Sky Into Firmament&nbsp");
        $("#change1").html("再点击一次可关闭");
    } else {
        $('#container').attr('class', 'container');
        $("#change").html("Illuminated&nbsp;Side&nbsp;!");
        $("#change1").html("A Place No One Have Found");
    }
});
